...
define('DB_NAME', 'u123456789_dental_db'); // Your Hostinger Database Name
define('DB_USER', 'u123456789_dental_user'); // Your Hostinger Database Username
define('DB_PASS', 'YOUR_STRONG_DATABASE_PASSWORD_HERE'); // Your Hostinger Database Password
